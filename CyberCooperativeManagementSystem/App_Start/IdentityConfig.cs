...
//using CyberCooperativeManagementSystem.Models;
...
namespace CyberCooperativeManagementSystem
{
    public class EmailService : IIdentityMessageService
    {
        public static string Decrypt(string decrypt)
        {
            ...
            try
            {
                byte[] data = System.Convert.FromBase64String(decrypt);
                ...
                DESCryptoServiceProvider descriptserviceProvider = new DESCryptoServiceProvider();
                ICryptoTransform x = descriptserviceProvider.CreateDecryptor(rgbKey, rgbIV);
        ...
        public Task SendAsync(IdentityMessage message)
        {
            ...
            var from = "obehiobehi123@gmail.com";
            var pass = "blw26L59HoAziqWZAL5FNA==";
